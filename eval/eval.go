...
func Eval(node ast.Node, env *object.Environment) object.Object {
	...
	case *ast.BlockStatment:
		return evalBlockStatments(node, env)
...
func applyFunction(fn object.Object, args []object.Object) object.Object {
	...
	scopedEnv := extendFunctionEnv(function, args)
	evaluated := Eval(function.Body, scopedEnv)
...
func evalBlockStatments(block *ast.BlockStatment, env *object.Environment) object.Object {
	var result object.Object
